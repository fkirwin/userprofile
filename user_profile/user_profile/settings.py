...
SECRET_KEY = '@^5abv&l*_)^sdslf;;;9999ud%n5llgj(!37w-g1nq2m5e03w'
...
AUTH_PASSWORD_VALIDATORS = [
    ...
    {
        'NAME': 'accounts.validators.AlphaLowerCharacterValidator',
    },
    {
        'NAME': 'accounts.validators.AlphaUpperCharacterValidator',
    },
    {
